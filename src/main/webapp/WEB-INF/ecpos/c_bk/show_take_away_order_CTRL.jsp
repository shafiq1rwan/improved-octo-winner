<script>
	app.controller('show_take_away_order_CTRL', function($scope, $http, $timeout, $location) {
		var vm = this;
		$scope.staffName = "";
		$scope.groupList = {};
		$scope.itemList = {};
		...
		function takeAwayDatatableDisplay() {
			var takeAwayDatatable = $('#takeaway_datatable').DataTable({
				"responsive" : true,
				"scrollY" : '25vh',
				"paging" : false,
				"destroy" : true,
		...
		function printKitchenReceipt(kitchenReceiptPrinting, checkNumber) {
			...
			$http.post("${pageContext.request.contextPath}/printerapi/printkitchenreceipt", jsonData).then(function(response) {
